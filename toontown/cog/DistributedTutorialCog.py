...
class DistributedTutorialCog(DistributedCogBase.DistributedCogBase, DelayDeletable):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedTutorialCog')
