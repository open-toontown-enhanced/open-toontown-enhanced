...
class DistributedLawbotBossCogAI(DistributedCogBaseAI.DistributedCogBaseAI):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedLawbotBossCogAI')
    ...
    def __init__(self, air, cogPlanner):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedLawbotBossCogAI', [
