...
class CogPlannerBase:
    ...
    SuitHoodInfo = [[2100,
     ...
     [13000,
      ...
      (8, 9, 10),
      []]]
    COG_HOOD_INFO_ZONE = 0
    COG_HOOD_INFO_MIN = 1
    COG_HOOD_INFO_MAX = 2
    COG_HOOD_INFO_BMIN = 3
    COG_HOOD_INFO_BMAX = 4
    COG_HOOD_INFO_BWEIGHT = 5
    COG_HOOD_INFO_SMAX = 6
    COG_HOOD_INFO_JCHANCE = 7
    COG_HOOD_INFO_TRACK = 8
    COG_HOOD_INFO_LVL = 9
    COG_HOOD_INFO_HEIGHTS = 10
    TOTAL_BWEIGHT = 0
    ...
    for currHoodInfo in SuitHoodInfo:
        ...
        currHoodInfo[COG_HOOD_INFO_HEIGHTS] = heights
