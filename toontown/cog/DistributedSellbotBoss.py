...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        nameInfo = TTLocalizer.BossCogNameWithDept % {'name': self._name,
         'dept': CogDNA.getDeptFullname(self.style.dept)}
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        promoteDoobers = TTLocalizer.BossCogPromoteDoobers % CogDNA.getDeptFullnameP(self.style.dept)
        doobersAway = TTLocalizer.BossCogDoobersAway[self.style.dept]
        welcomeToons = TTLocalizer.BossCogWelcomeToons
        promoteToons = TTLocalizer.BossCogPromoteToons % CogDNA.getDeptFullnameP(self.style.dept)
        ...
        dialogTrack = Track(
            ...
            (34, Sequence(
                Func(self.clearChat),
                self.loseCogCogs(self.toonsA, self.battleANode, (0, 18, 5, -180, 0, 0)),
                self.loseCogCogs(self.toonsB, self.battleBNode, (0, 18, 5, -180, 0, 0)))),
            (37, Sequence(
