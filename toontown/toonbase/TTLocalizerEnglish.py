...
CogFont = 'phase_3/models/fonts/vtRemingtonPortable.ttf'
...
QuestCogPartQuestCogPart = 'Cog Disguise Part'
...
QuestsCogPartQuestDesc = 'a Cog Disguise Part'
QuestsCogPartQuestDescC = '%(count)s Cog Disguise Parts'
QuestsCogPartQuestDescI = 'some Cog Disguise Parts'
...
QuestsCogDisguisePartReward = 'You now have a %(cogTrack)s %(part)s Cog Disguise Part.'
...
CogFlunky = 'Flunky'
CogPencilPusher = 'Pencil Pusher'
CogYesman = 'Yesman'
CogMicromanager = 'Micro\x03manager'
CogDownsizer = 'Downsizer'
CogHeadHunter = 'Head Hunter'
CogCorporateRaider = 'Corporate Raider'
CogTheBigCheese = 'The Big Cheese'
CogColdCaller = 'Cold Caller'
CogTelemarketer = 'Tele\x03marketer'
CogNameDropper = 'Name Dropper'
CogGladHander = 'Glad Hander'
CogMoverShaker = 'Mover & Shaker'
CogTwoFace = 'Two-Face'
CogTheMingler = 'The Mingler'
CogMrHollywood = 'Mr. Hollywood'
CogShortChange = 'Short Change'
CogPennyPincher = 'Penny Pincher'
CogTightwad = 'Tightwad'
CogBeanCounter = 'Bean Counter'
CogNumberCruncher = 'Number Cruncher'
CogMoneyBags = 'Money Bags'
CogLoanShark = 'Loan Shark'
CogRobberBaron = 'Robber Baron'
CogBottomFeeder = 'Bottom Feeder'
CogBloodsucker = 'Blood\x03sucker'
CogDoubleTalker = 'Double Talker'
CogAmbulanceChaser = 'Ambulance Chaser'
CogBackStabber = 'Back Stabber'
CogSpinDoctor = 'Spin Doctor'
CogLegalEagle = 'Legal Eagle'
CogBigWig = 'Big Wig'
CogFlunkyS = 'a Flunky'
CogPencilPusherS = 'a Pencil Pusher'
CogYesmanS = 'a Yesman'
CogMicromanagerS = 'a Micromanager'
CogDownsizerS = 'a Downsizer'
CogHeadHunterS = 'a Head Hunter'
CogCorporateRaiderS = 'a Corporate Raider'
CogTheBigCheeseS = 'a The Big Cheese'
CogColdCallerS = 'a Cold Caller'
CogTelemarketerS = 'a Telemarketer'
CogNameDropperS = 'a Name Dropper'
CogGladHanderS = 'a Glad Hander'
CogMoverShakerS = 'a Mover & Shaker'
CogTwoFaceS = 'a Two-Face'
CogTheMinglerS = 'a The Mingler'
CogMrHollywoodS = 'a Mr. Hollywood'
CogShortChangeS = 'a Short Change'
CogPennyPincherS = 'a Penny Pincher'
CogTightwadS = 'a Tightwad'
CogBeanCounterS = 'a Bean Counter'
CogNumberCruncherS = 'a Number Cruncher'
CogMoneyBagsS = 'a Money Bags'
CogLoanSharkS = 'a Loan Shark'
CogRobberBaronS = 'a Robber Baron'
CogBottomFeederS = 'a Bottom Feeder'
CogBloodsuckerS = 'a Bloodsucker'
CogDoubleTalkerS = 'a Double Talker'
CogAmbulanceChaserS = 'an Ambulance Chaser'
CogBackStabberS = 'a Back Stabber'
CogSpinDoctorS = 'a Spin Doctor'
CogLegalEagleS = 'a Legal Eagle'
CogBigWigS = 'a Big Wig'
CogFlunkyP = 'Flunkies'
CogPencilPusherP = 'Pencil Pushers'
CogYesmanP = 'Yesmen'
CogMicromanagerP = 'Micromanagers'
CogDownsizerP = 'Downsizers'
CogHeadHunterP = 'Head Hunters'
CogCorporateRaiderP = 'Corporate Raiders'
CogTheBigCheeseP = 'The Big Cheeses'
CogColdCallerP = 'Cold Callers'
CogTelemarketerP = 'Telemarketers'
CogNameDropperP = 'Name Droppers'
CogGladHanderP = 'Glad Handers'
CogMoverShakerP = 'Movers & Shakers'
CogTwoFaceP = 'Two-Faces'
CogTheMinglerP = 'The Minglers'
CogMrHollywoodP = 'Mr. Hollywoods'
CogShortChangeP = 'Short Changes'
CogPennyPincherP = 'Penny Pinchers'
CogTightwadP = 'Tightwads'
CogBeanCounterP = 'Bean Counters'
CogNumberCruncherP = 'Number Crunchers'
CogMoneyBagsP = 'Money Bags'
CogLoanSharkP = 'Loan Sharks'
CogRobberBaronP = 'Robber Barons'
CogBottomFeederP = 'Bottom Feeders'
CogBloodsuckerP = 'Bloodsuckers'
CogDoubleTalkerP = 'Double Talkers'
CogAmbulanceChaserP = 'Ambulance Chasers'
CogBackStabberP = 'Back Stabbers'
CogSpinDoctorP = 'Spin Doctors'
CogLegalEagleP = 'Legal Eagles'
CogBigWigP = 'Big Wigs'
CogFaceoffDefaultTaunts = ['Boo!']
...
MusicEncntrGeneralCogWinningIndoor = 'Cog-tastrophe!'
...
MusicEncntrCogHqNbrhood = 'Dollars and Cents'
MusicChqFactBg = 'Cog Factory'
MusicCoghqFinale = 'Triumph of the Toons'
MusicEncntrToonWinning = 'Cashing In!'
MusicEncntrCogWinning = 'Selling You Short'
MusicEncntrHeadCogTheme = 'The Big Boss'
...
MintElevatorRejectMessage = 'You cannot enter the Mints until you have completed your %s Cog Disguise.'
...
SellbotRentalDisguiseMessage = "Wear this Rental Disguise so you can get close enough to the VP to attack.\n\nYou won't earn merits or promotions, but you can rescue a Toon for an SOS reward!"
...
SellbotCogDisguiseHasMeritsMessage = "It's Operation: Storm Sellbot!\n\nBring 5 or more Rental Disguise Toons with you to defeat the VP and earn credit towards a reward!"
...
WitnessToonLastPromotion = "\x07Wow, you've reached level %s on your Cog Disguise!\x07Cogs don't get promoted higher than that.\x07You can't upgrade your Cog Disguise anymore, but you can certainly keep working for the Resistance!"
...
WitnessToonMaxed = '\x07I see that you have a level %s Cog Disguise. Very impressive!\x07On behalf of the Toon Council, thank you for coming back to defend more Toons!'
...
BossbotRTRemoveCog = 'First take off your cog suits...'
...
BossbotRTLastPromotion = "\x07Wow, you've reached level %s on your Cog Disguise!\x07Cogs don't get promoted higher than that.\x07You can't upgrade your Cog Disguise anymore, but you can certainly keep working for the Resistance!"
...
BossbotRTMaxed = '\x07I see that you have a level %s Cog Disguise. Very impressive!\x07On behalf of the Toon Council, thank you for coming back to defend more Toons!'
