...
DamagePerBullet = 25
EnemyBaseHealth = 25
EnemyHealthMultiplier = {'flunky': 1,
 'pencil_pusher': 1,
 'yesman': 1,
 'micromanager': 1,
 'bottom_feeder': 1,
...
BlockList0 = [[BLOCK_H24, [(0, 0, 12)]],
 ...
 [BLOCK_H24, [(0, 0, 18.75)]]]
EnemyList0 = [['telemarketer', [(35, 0, 12.65), (30, 0, 12.65), 2]], ['telemarketer', [(24, 0, 12.65), (24, 0, 30.0), 2]]]
...
EnemyList1 = [['flunky', [(20, 0, 6), (50, 0, 6), 3.5]],
 ['bottom_feeder', [(50, 0, 6), (20, 0, 6), 3.5]],
 ['flunky', [(62, 0, 6), (90, 0, 6), 3.5]],
 ['bottom_feeder', [(90, 0, 6), (62, 0, 6), 3.5]],
 ['double_talker', [(52, 0, 6), (52, 0, 28), 3.5]],
 ['bloodsucker', [(60, 0, 28), (60, 0, 6), 3.5]]]
...
EnemyList2 = [['pencil_pusher', [(31, 0, 6), (31, 0, 31), 3.5]],
 ['yesman', [(31, 0, 31), (31, 0, 6), 3.5]],
 ['bottom_feeder', [(61, 0, 6), (61, 0, 31), 3.5]],
 ['bloodsucker', [(61, 0, 31), (61, 0, 6), 3.5]],
 ['short_change', [(35, 0, 26.25), (57, 0, 26.25), 3.5]],
 ['tightwad', [(57, 0, 26.25), (35, 0, 26.25), 3.5]]]
...
SpawnPointList3 = [[(2, 0, 16)],
 ...
 [(108, 0, 9.25)],
 [(162, 0, 9.25)]]
EnemyList3 = [['pencil_pusher', [(31, 0, 6), (31, 0, 31), 3.5]],
 ['yesman', [(31, 0, 31), (31, 0, 6), 3.5]],
 ['bottom_feeder', [(61, 0, 6), (61, 0, 31), 3.5]],
 ['bloodsucker', [(61, 0, 31), (61, 0, 6), 3.5]],
 ['short_change', [(35, 0, 26.25), (57, 0, 26.25), 3.5]],
...
TreasureList11 = [[(4, 0, 34)],
 ...
 [(140, 0, 34)],
 [(162, 0, 34)]]
EnemyList11 = [['cold_caller', [(26, 0, 12.75), (46, 0, 12.75), 3.5]], ['telemarketer', [(74, 0, 6), (94, 0, 6), 3.5]], ['short_change', [(122, 0, 19.5), (142, 0, 19.5), 3.5]]]
...
EnemyList13 = [['cold_caller', [(20, 0, 12.75), (48, 0, 12.75), 3.5]],
 ['cold_caller', [(48, 0, 12.75), (20, 0, 12.75), 3.5]],
 ['short_change', [(92, 0, 31), (92, 0, -1), 3.5]],
 ['short_change', [(92, 0, -1), (92, 0, 31), 3.5]],
 ['cold_caller', [(146, 0, 12.75), (174, 0, 12.75), 3.5]],
 ['cold_caller', [(174, 0, 12.75), (146, 0, 12.75), 3.5]]]
...
EnemyList4 = [['cold_caller', [(26, 0, 12.75), (46, 0, 12.75), 3.5]], ['telemarketer', [(74, 0, 6), (94, 0, 6), 3.5]], ['short_change', [(122, 0, 19.5), (142, 0, 19.5), 3.5]]]
