...
class DistributedMintElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setMintId(self, mintId):
        ...
        signText = DirectGui.OnscreenText(text=TextEncoder.upper(TTLocalizer.GlobalStreetNames[mintId][-1]), font=ToontownGlobals.getCogFont(), scale=TTLocalizer.DMEEsignText, fg=(0.87, 0.87, 0.87, 1), mayChange=False, parent=backgroundGeom)
