...
class DistributedCountryClubBattleAI(DistributedLevelBattleAI.DistributedLevelBattleAI):
    ...
    def __init__(self, air, battleMgr, pos, cog, toonId, zoneId, level, battleCellId, roundCallback=None, finishCallback=None, maxCogs=4):
        DistributedLevelBattleAI.DistributedLevelBattleAI.__init__(self, air, battleMgr, pos, cog, toonId, zoneId, level, battleCellId, 'CountryClubReward', roundCallback, finishCallback, maxCogs)
