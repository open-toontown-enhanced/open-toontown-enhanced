...
class LevelBattleManagerAI(BattleManagerAI.BattleManagerAI):
    ...
    def newBattle(self, cellId, zoneId, pos, cog, toonId, roundCallback=None, finishCallback=None, maxCogs=4):
        ...
        if battle != None:
            ...
            battle = self.battleCtor(self.air, self, pos, cog, toonId, zoneId, self.level, cellId, roundCallback, finishCallback, maxCogs)
