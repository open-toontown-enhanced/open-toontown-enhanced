...
class DistributedCogInterior(DistributedObject.DistributedObject):
    id = 0
    ...
    def __init__(self, cr):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedCogInterior', [State.State('WaitForAllToonsInside', self.enterWaitForAllToonsInside, self.exitWaitForAllToonsInside, ['Elevator']),
    ...
    def __uniqueName(self, name):
        DistributedCogInterior.id += 1
        return name + '%d' % DistributedCogInterior.id
