...
class GZSafeZoneLoader(SafeZoneLoader):
    ...
    def enterPlayground(self, requestStatus):
        ...
        signText = DirectGui.OnscreenText(text=TextEncoder.upper(TTLocalizer.BossbotHQ[-1]), font=ToontownGlobals.getCogFont(), scale=TTLocalizer.GZSZLsignText, fg=(0, 0, 0, 1), mayChange=False, parent=sign)
