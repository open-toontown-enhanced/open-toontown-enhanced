...
EmoteFuncDict = {'Wave': 0,
 ...
 'Sing Note F': 31,
 'Sing Note G2': 32}
CogBrushOffs = {'flunky': ["I'm late for a meeting."],
 'pencil_pusher': ['Push off.'],
 'yesman': ['Yes Man says NO.'],
 None: ["It's my day off.",
        "I believe you're in the wrong office.",
        'Have your people call my people.',
        "You're in no position to meet with me.",
        'Talk to my assistant.']}
CogFaceoffTaunts = {'bloodsucker': ['Do you have a donation for me?',
 ...
 'the_mingler': ["You don't know who you're mingling with.",
 ...
 'mover_and_shaker': ['Get ready for a shake down.',
        ...
        'Are you shaking yet?'],
 'head_hunter': ["I'm way ahead of you.",
 ...
 'the_big_cheese': ["Watch out, I'm gouda getcha.",
 ...
 'mr_hollywood': ['Are you ready for my take?',
 ...
 'number_cruncher': ['Looks like your number is up.',
 ...
 'loan_shark': ["It's time to collect on your loan.",
 ...
 'money_bags': ['Time to bring in the big bags.',
        'I can bag this.',
        'Paper or plastic?',
 ...
 'robber_baron': ["You've been robbed.",
 ...
 'back_stabber': ['Never turn your back on me.',
 ...
 'legal_eagle': ["Careful, my legal isn't very tender.",
        'I soar, then I score.',
 ...
 'spin_doctor': ["You'll never know when I'll stop.",
 ...
 'pencil_pusher': ["I'm gonna rub you out!",
 ...
 'cold_caller': ['Surprised to hear from me?',
        'You rang?',
 ...
 'name_dropper': ['In my opinion, your name is mud.',
 ...
 'short_change': ['I will make short work of you.',
        "You're about to have money trouble.",
 ...
 'penny_pincher': ['This is going to sting a little.',
 ...
 'bean_counter': ['I enjoy subtracting Toons.',
 ...
 'bottom_feeder': ["Looks like you've hit rock bottom.",
        "I'm ready to feast.",
 ...
 'two_face': ["It's time to face-off!",
 ...
 'double_talker': ["I'm gonna give you double the trouble.",
        ...
        'Doubles anyone??'],
 'ambulance_chaser': ["I'm going to chase you out of town!",
        'Do you hear a siren?',
        "I'm going to enjoy this.",
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 1207: 'I need more Sellbot Disguise Parts.',
 ...
 1213: 'I need more Cashbot Disguise Parts.',
 1214: 'I need more Lawbot Disguise Parts.',
 1215: 'I need more Bossbot Disguise Parts.',
 ...
 20000: CogBrushOffs[None][0],
 20001: CogBrushOffs[None][1],
 20002: CogBrushOffs[None][2],
 20003: CogBrushOffs[None][3],
 20004: CogBrushOffs[None][4],
 20005: CogFaceoffTaunts['bottom_feeder'][0],
 20006: CogFaceoffTaunts['bottom_feeder'][1],
 20007: CogFaceoffTaunts['bottom_feeder'][2],
 20008: CogFaceoffTaunts['bottom_feeder'][3],
 20009: CogFaceoffTaunts['bottom_feeder'][4],
 20010: CogFaceoffTaunts['bottom_feeder'][5],
 20011: CogFaceoffTaunts['bottom_feeder'][6],
 20012: CogFaceoffTaunts['bottom_feeder'][7],
 20013: CogFaceoffTaunts['bottom_feeder'][8],
 20014: CogFaceoffTaunts['bottom_feeder'][9],
 20015: CogFaceoffTaunts['number_cruncher'][0],
 20016: CogFaceoffTaunts['number_cruncher'][1],
 20017: CogFaceoffTaunts['number_cruncher'][2],
 20018: CogFaceoffTaunts['number_cruncher'][3],
 20019: CogFaceoffTaunts['number_cruncher'][4],
 20020: CogFaceoffTaunts['number_cruncher'][5],
 20021: CogFaceoffTaunts['number_cruncher'][6],
 20022: CogFaceoffTaunts['number_cruncher'][7],
 20023: CogFaceoffTaunts['number_cruncher'][8],
 20024: CogFaceoffTaunts['number_cruncher'][9],
 20025: CogFaceoffTaunts['yesman'][0],
 20026: CogFaceoffTaunts['yesman'][1],
 20027: CogFaceoffTaunts['yesman'][2],
 20028: CogFaceoffTaunts['yesman'][3],
 20029: CogFaceoffTaunts['yesman'][4],
 20030: CogFaceoffTaunts['yesman'][5],
 20031: CogFaceoffTaunts['yesman'][6],
 20032: CogFaceoffTaunts['yesman'][7],
 20033: CogFaceoffTaunts['yesman'][8],
 20034: CogFaceoffTaunts['yesman'][9],
 20035: CogFaceoffTaunts['yesman'][10],
 20036: CogFaceoffTaunts['mover_and_shaker'][0],
 20037: CogFaceoffTaunts['mover_and_shaker'][1],
 20038: CogFaceoffTaunts['mover_and_shaker'][2],
 20039: CogFaceoffTaunts['mover_and_shaker'][3],
 20040: CogFaceoffTaunts['mover_and_shaker'][4],
 20041: CogFaceoffTaunts['mover_and_shaker'][5],
 20042: CogFaceoffTaunts['mover_and_shaker'][6],
 20043: CogFaceoffTaunts['mover_and_shaker'][7],
 20044: CogFaceoffTaunts['mover_and_shaker'][8],
 20045: CogFaceoffTaunts['mover_and_shaker'][9],
 20046: CogFaceoffTaunts['mover_and_shaker'][10],
 20047: CogFaceoffTaunts['bean_counter'][0],
 20048: CogFaceoffTaunts['bean_counter'][1],
 20049: CogFaceoffTaunts['bean_counter'][2],
 20050: CogFaceoffTaunts['bean_counter'][3],
 20051: CogFaceoffTaunts['bean_counter'][4],
 20052: CogFaceoffTaunts['bean_counter'][5],
 20053: CogFaceoffTaunts['bean_counter'][6],
 20054: CogFaceoffTaunts['bean_counter'][7],
 20055: CogFaceoffTaunts['bean_counter'][8],
 20056: CogFaceoffTaunts['bean_counter'][9],
 20057: CogFaceoffTaunts['bean_counter'][10],
 20058: CogFaceoffTaunts['cold_caller'][0],
 20059: CogFaceoffTaunts['cold_caller'][1],
 20060: CogFaceoffTaunts['cold_caller'][2],
 20061: CogFaceoffTaunts['cold_caller'][3],
 20062: CogFaceoffTaunts['cold_caller'][4],
 20063: CogFaceoffTaunts['cold_caller'][5],
 20064: CogFaceoffTaunts['cold_caller'][6],
 20065: CogFaceoffTaunts['cold_caller'][7],
 20066: CogFaceoffTaunts['cold_caller'][8],
 20067: CogFaceoffTaunts['cold_caller'][9],
 20068: CogFaceoffTaunts['cold_caller'][10],
 20069: CogFaceoffTaunts['cold_caller'][11],
 20070: CogFaceoffTaunts['cold_caller'][12],
 20071: CogFaceoffTaunts['name_dropper'][0],
 20072: CogFaceoffTaunts['name_dropper'][1],
 20073: CogFaceoffTaunts['name_dropper'][2],
 20074: CogFaceoffTaunts['name_dropper'][3],
 20075: CogFaceoffTaunts['name_dropper'][4],
 20076: CogFaceoffTaunts['name_dropper'][5],
 20077: CogFaceoffTaunts['name_dropper'][6],
 20078: CogFaceoffTaunts['name_dropper'][7],
 20079: CogFaceoffTaunts['name_dropper'][8],
 20080: CogFaceoffTaunts['name_dropper'][9],
 20081: CogFaceoffTaunts['ambulance_chaser'][0],
 20082: CogFaceoffTaunts['ambulance_chaser'][1],
 20083: CogFaceoffTaunts['ambulance_chaser'][2],
 20084: CogFaceoffTaunts['ambulance_chaser'][3],
 20085: CogFaceoffTaunts['ambulance_chaser'][4],
 20086: CogFaceoffTaunts['ambulance_chaser'][5],
 20087: CogFaceoffTaunts['ambulance_chaser'][6],
 20088: CogFaceoffTaunts['ambulance_chaser'][7],
 20089: CogFaceoffTaunts['ambulance_chaser'][8],
 20090: CogFaceoffTaunts['ambulance_chaser'][9],
 20091: CogFaceoffTaunts['ambulance_chaser'][10],
 20092: CogFaceoffTaunts['ambulance_chaser'][11],
 20093: CogFaceoffTaunts['two_face'][0],
 20094: CogFaceoffTaunts['two_face'][1],
 20095: CogFaceoffTaunts['two_face'][2],
 20096: CogFaceoffTaunts['two_face'][3],
 20097: CogFaceoffTaunts['two_face'][4],
 20098: CogFaceoffTaunts['two_face'][5],
 20099: CogFaceoffTaunts['two_face'][6],
 20100: CogFaceoffTaunts['two_face'][7],
 20101: CogFaceoffTaunts['two_face'][8],
 20102: CogFaceoffTaunts['two_face'][9],
 20103: CogFaceoffTaunts['two_face'][10],
 20104: CogFaceoffTaunts['head_hunter'][0],
 20105: CogFaceoffTaunts['head_hunter'][1],
 20106: CogFaceoffTaunts['head_hunter'][2],
 20107: CogFaceoffTaunts['head_hunter'][3],
 20108: CogFaceoffTaunts['head_hunter'][4],
 20109: CogFaceoffTaunts['head_hunter'][5],
 20110: CogFaceoffTaunts['head_hunter'][6],
 20111: CogFaceoffTaunts['head_hunter'][7],
 20112: CogFaceoffTaunts['head_hunter'][8],
 20113: CogFaceoffTaunts['head_hunter'][9],
 20114: CogFaceoffTaunts['head_hunter'][10],
 20115: CogFaceoffTaunts['legal_eagle'][0],
 20116: CogFaceoffTaunts['legal_eagle'][1],
 20117: CogFaceoffTaunts['legal_eagle'][2],
 20118: CogFaceoffTaunts['legal_eagle'][3],
 20119: CogFaceoffTaunts['legal_eagle'][4],
 20120: CogFaceoffTaunts['legal_eagle'][5],
 20121: CogFaceoffTaunts['legal_eagle'][6],
 20122: CogFaceoffTaunts['legal_eagle'][7],
 20123: CogFaceoffTaunts['legal_eagle'][8],
 20124: CogFaceoffTaunts['legal_eagle'][9],
 20125: CogFaceoffTaunts['back_stabber'][0],
 20126: CogFaceoffTaunts['back_stabber'][1],
 20127: CogFaceoffTaunts['back_stabber'][2],
 20128: CogFaceoffTaunts['back_stabber'][3],
 20129: CogFaceoffTaunts['back_stabber'][4],
 20130: CogFaceoffTaunts['back_stabber'][5],
 20131: CogFaceoffTaunts['back_stabber'][6],
 20132: CogFaceoffTaunts['back_stabber'][7],
 20133: CogFaceoffTaunts['back_stabber'][8],
 20134: CogFaceoffTaunts['back_stabber'][9],
 20135: CogFaceoffTaunts['back_stabber'][10],
 20136: CogFaceoffTaunts['corporate_raider'][0],
 20137: CogFaceoffTaunts['corporate_raider'][1],
 20138: CogFaceoffTaunts['corporate_raider'][2],
 20139: CogFaceoffTaunts['corporate_raider'][3],
 20140: CogFaceoffTaunts['corporate_raider'][4],
 20141: CogFaceoffTaunts['corporate_raider'][5],
 20142: CogFaceoffTaunts['corporate_raider'][6],
 20143: CogFaceoffTaunts['corporate_raider'][7],
 20144: CogFaceoffTaunts['corporate_raider'][8],
 20145: CogFaceoffTaunts['corporate_raider'][9],
 20146: CogFaceoffTaunts['the_big_cheese'][0],
 20147: CogFaceoffTaunts['the_big_cheese'][1],
 20148: CogFaceoffTaunts['the_big_cheese'][2],
 20149: CogFaceoffTaunts['the_big_cheese'][3],
 20150: CogFaceoffTaunts['the_big_cheese'][4],
 20151: CogFaceoffTaunts['the_big_cheese'][5],
 20152: CogFaceoffTaunts['the_big_cheese'][6],
 20153: CogFaceoffTaunts['the_big_cheese'][7],
 20154: CogFaceoffTaunts['the_big_cheese'][8],
 20155: CogFaceoffTaunts['the_big_cheese'][9],
 20156: CogFaceoffTaunts['the_big_cheese'][10],
 20157: CogFaceoffTaunts['downsizer'][0],
 20158: CogFaceoffTaunts['downsizer'][1],
 20159: CogFaceoffTaunts['downsizer'][2],
 20160: CogFaceoffTaunts['downsizer'][3],
 20161: CogFaceoffTaunts['downsizer'][4],
 20162: CogFaceoffTaunts['downsizer'][5],
 20163: CogFaceoffTaunts['downsizer'][6],
 20164: CogFaceoffTaunts['downsizer'][7],
 20165: CogFaceoffTaunts['glad_hander'][0],
 20166: CogFaceoffTaunts['glad_hander'][1],
 20167: CogFaceoffTaunts['glad_hander'][2],
 20168: CogFaceoffTaunts['glad_hander'][3],
 20169: CogFaceoffTaunts['glad_hander'][4],
 20170: CogFaceoffTaunts['glad_hander'][5],
 20171: CogFaceoffTaunts['glad_hander'][6],
 20172: CogFaceoffTaunts['glad_hander'][7],
 20173: CogFaceoffTaunts['glad_hander'][8],
 20174: CogFaceoffTaunts['glad_hander'][9],
 20175: CogFaceoffTaunts['glad_hander'][10],
 20176: CogFaceoffTaunts['glad_hander'][11],
 20177: CogFaceoffTaunts['glad_hander'][12],
 20178: CogFaceoffTaunts['penny_pincher'][0],
 20179: CogFaceoffTaunts['penny_pincher'][1],
 20180: CogFaceoffTaunts['penny_pincher'][2],
 20181: CogFaceoffTaunts['penny_pincher'][3],
 20182: CogFaceoffTaunts['penny_pincher'][4],
 20183: CogFaceoffTaunts['penny_pincher'][5],
 20184: CogFaceoffTaunts['penny_pincher'][6],
 20185: CogFaceoffTaunts['penny_pincher'][7],
 20186: CogFaceoffTaunts['penny_pincher'][8],
 20187: CogFaceoffTaunts['penny_pincher'][9],
 20188: CogFaceoffTaunts['bloodsucker'][0],
 20189: CogFaceoffTaunts['bloodsucker'][1],
 20190: CogFaceoffTaunts['bloodsucker'][2],
 20191: CogFaceoffTaunts['bloodsucker'][3],
 20192: CogFaceoffTaunts['bloodsucker'][4],
 20193: CogFaceoffTaunts['bloodsucker'][5],
 20194: CogFaceoffTaunts['bloodsucker'][6],
 20195: CogFaceoffTaunts['bloodsucker'][7],
 20196: CogFaceoffTaunts['bloodsucker'][8],
 20197: CogFaceoffTaunts['bloodsucker'][9],
 20198: CogFaceoffTaunts['bloodsucker'][10],
 20199: CogFaceoffTaunts['bloodsucker'][11],
 20200: CogFaceoffTaunts['flunky'][0],
 20201: CogFaceoffTaunts['flunky'][1],
 20202: CogFaceoffTaunts['flunky'][2],
 20203: CogFaceoffTaunts['flunky'][3],
 20204: CogFaceoffTaunts['flunky'][4],
 20205: CogFaceoffTaunts['flunky'][5],
 20206: CogFaceoffTaunts['flunky'][6],
 20207: CogFaceoffTaunts['flunky'][7],
 20208: CogFaceoffTaunts['flunky'][8],
 20209: CogFaceoffTaunts['flunky'][9],
 20210: CogFaceoffTaunts['flunky'][10],
 20211: CogFaceoffTaunts['micromanager'][0],
 20212: CogFaceoffTaunts['micromanager'][1],
 20213: CogFaceoffTaunts['micromanager'][2],
 20214: CogFaceoffTaunts['micromanager'][3],
 20215: CogFaceoffTaunts['micromanager'][4],
 20216: CogFaceoffTaunts['micromanager'][5],
 20217: CogFaceoffTaunts['micromanager'][6],
 20218: CogFaceoffTaunts['micromanager'][7],
 20219: CogFaceoffTaunts['micromanager'][8],
 20220: CogFaceoffTaunts['micromanager'][9],
 20221: CogFaceoffTaunts['micromanager'][10],
 20222: CogFaceoffTaunts['micromanager'][11],
 20223: CogFaceoffTaunts['micromanager'][12],
 20224: CogFaceoffTaunts['micromanager'][13],
 20225: CogFaceoffTaunts['tightwad'][0],
 20226: CogFaceoffTaunts['tightwad'][1],
 20227: CogFaceoffTaunts['tightwad'][2],
 20228: CogFaceoffTaunts['tightwad'][3],
 20229: CogFaceoffTaunts['tightwad'][4],
 20230: CogFaceoffTaunts['tightwad'][5],
 20231: CogFaceoffTaunts['tightwad'][6],
 20232: CogFaceoffTaunts['tightwad'][7],
 20233: CogFaceoffTaunts['tightwad'][8],
 20234: CogFaceoffTaunts['tightwad'][9],
 20235: CogFaceoffTaunts['tightwad'][10],
 20236: CogFaceoffTaunts['money_bags'][0],
 20237: CogFaceoffTaunts['money_bags'][1],
 20238: CogFaceoffTaunts['money_bags'][2],
 20239: CogFaceoffTaunts['money_bags'][3],
 20240: CogFaceoffTaunts['money_bags'][4],
 20241: CogFaceoffTaunts['money_bags'][5],
 20242: CogFaceoffTaunts['money_bags'][6],
 20243: CogFaceoffTaunts['money_bags'][7],
 20244: CogFaceoffTaunts['money_bags'][8],
 20245: CogFaceoffTaunts['money_bags'][9],
 20246: CogFaceoffTaunts['the_mingler'][0],
 20247: CogFaceoffTaunts['the_mingler'][1],
 20248: CogFaceoffTaunts['the_mingler'][2],
 20249: CogFaceoffTaunts['the_mingler'][3],
 20250: CogFaceoffTaunts['the_mingler'][4],
 20251: CogFaceoffTaunts['the_mingler'][5],
 20252: CogFaceoffTaunts['the_mingler'][6],
 20253: CogFaceoffTaunts['the_mingler'][7],
 20254: CogFaceoffTaunts['the_mingler'][8],
 20255: CogFaceoffTaunts['mr_hollywood'][0],
 20256: CogFaceoffTaunts['mr_hollywood'][1],
 20257: CogFaceoffTaunts['mr_hollywood'][2],
 20258: CogFaceoffTaunts['mr_hollywood'][3],
 20259: CogFaceoffTaunts['mr_hollywood'][4],
 20260: CogFaceoffTaunts['mr_hollywood'][5],
 20261: CogFaceoffTaunts['mr_hollywood'][6],
 20262: CogFaceoffTaunts['mr_hollywood'][7],
 20263: CogFaceoffTaunts['mr_hollywood'][8],
 20264: CogFaceoffTaunts['mr_hollywood'][9],
 20265: CogFaceoffTaunts['mr_hollywood'][10],
 20266: CogFaceoffTaunts['mr_hollywood'][11],
 20267: CogFaceoffTaunts['double_talker'][0],
 20268: CogFaceoffTaunts['double_talker'][1],
 20269: CogFaceoffTaunts['double_talker'][2],
 20270: CogFaceoffTaunts['double_talker'][3],
 20271: CogFaceoffTaunts['double_talker'][4],
 20272: CogFaceoffTaunts['double_talker'][5],
 20273: CogFaceoffTaunts['double_talker'][6],
 20274: CogFaceoffTaunts['double_talker'][7],
 20275: CogFaceoffTaunts['double_talker'][8],
 20276: CogFaceoffTaunts['double_talker'][9],
 20277: CogFaceoffTaunts['pencil_pusher'][0],
 20278: CogFaceoffTaunts['pencil_pusher'][1],
 20279: CogFaceoffTaunts['pencil_pusher'][2],
 20280: CogFaceoffTaunts['pencil_pusher'][3],
 20281: CogFaceoffTaunts['pencil_pusher'][4],
 20282: CogFaceoffTaunts['pencil_pusher'][5],
 20283: CogFaceoffTaunts['pencil_pusher'][6],
 20284: CogFaceoffTaunts['pencil_pusher'][7],
 20285: CogFaceoffTaunts['pencil_pusher'][8],
 20286: CogFaceoffTaunts['pencil_pusher'][9],
 20287: CogFaceoffTaunts['pencil_pusher'][10],
 20288: CogFaceoffTaunts['telemarketer'][0],
 20289: CogFaceoffTaunts['telemarketer'][1],
 20290: CogFaceoffTaunts['telemarketer'][2],
 20291: CogFaceoffTaunts['telemarketer'][3],
 20292: CogFaceoffTaunts['telemarketer'][4],
 20293: CogFaceoffTaunts['telemarketer'][5],
 20294: CogFaceoffTaunts['telemarketer'][6],
 20295: CogFaceoffTaunts['telemarketer'][7],
 20296: CogFaceoffTaunts['telemarketer'][8],
 20297: CogFaceoffTaunts['telemarketer'][9],
 20298: CogFaceoffTaunts['telemarketer'][10],
 20299: CogFaceoffTaunts['big_wig'][0],
 20300: CogFaceoffTaunts['big_wig'][1],
 20301: CogFaceoffTaunts['big_wig'][2],
 20302: CogFaceoffTaunts['big_wig'][3],
 20303: CogFaceoffTaunts['big_wig'][4],
 20304: CogFaceoffTaunts['big_wig'][5],
 20305: CogFaceoffTaunts['big_wig'][6],
 20306: CogFaceoffTaunts['big_wig'][7],
 20307: CogFaceoffTaunts['big_wig'][8],
 20308: CogFaceoffTaunts['big_wig'][9],
 20309: CogFaceoffTaunts['loan_shark'][0],
 20310: CogFaceoffTaunts['loan_shark'][1],
 20311: CogFaceoffTaunts['loan_shark'][2],
 20312: CogFaceoffTaunts['loan_shark'][3],
 20313: CogFaceoffTaunts['loan_shark'][4],
 20314: CogFaceoffTaunts['loan_shark'][5],
 20315: CogFaceoffTaunts['loan_shark'][6],
 20316: CogFaceoffTaunts['loan_shark'][7],
 20317: CogFaceoffTaunts['loan_shark'][8],
 20318: CogFaceoffTaunts['loan_shark'][9],
 20319: CogFaceoffTaunts['loan_shark'][10],
 20320: CogFaceoffTaunts['robber_baron'][0],
 20321: CogFaceoffTaunts['robber_baron'][1],
 20322: CogFaceoffTaunts['robber_baron'][2],
 20323: CogFaceoffTaunts['robber_baron'][3],
 20324: CogFaceoffTaunts['robber_baron'][4],
 20325: CogFaceoffTaunts['robber_baron'][5],
 20326: CogFaceoffTaunts['robber_baron'][6],
 20327: CogFaceoffTaunts['robber_baron'][7],
 20328: CogFaceoffTaunts['robber_baron'][8],
 20329: CogFaceoffTaunts['robber_baron'][9],
 20330: CogFaceoffTaunts['short_change'][0],
 20331: CogFaceoffTaunts['short_change'][1],
 20332: CogFaceoffTaunts['short_change'][2],
 20333: CogFaceoffTaunts['short_change'][3],
 20334: CogFaceoffTaunts['short_change'][4],
 20335: CogFaceoffTaunts['short_change'][5],
 20336: CogFaceoffTaunts['short_change'][6],
 20337: CogFaceoffTaunts['short_change'][7],
 20338: CogFaceoffTaunts['short_change'][8],
 20339: CogFaceoffTaunts['short_change'][9],
 20340: CogFaceoffTaunts['short_change'][10],
 20341: CogFaceoffTaunts['spin_doctor'][0],
 20342: CogFaceoffTaunts['spin_doctor'][1],
 20343: CogFaceoffTaunts['spin_doctor'][2],
 20344: CogFaceoffTaunts['spin_doctor'][3],
 20345: CogFaceoffTaunts['spin_doctor'][4],
 20346: CogFaceoffTaunts['spin_doctor'][5],
 20347: CogFaceoffTaunts['spin_doctor'][6],
 20348: CogFaceoffTaunts['spin_doctor'][7],
 20349: CogFaceoffTaunts['spin_doctor'][8],
 20350: CogFaceoffTaunts['spin_doctor'][9],
 21000: 'Here boy!',
 21001: 'Here girl!',
 21002: 'Stay.',
 21003: 'Good boy!',
 ...
 30155: 'You get a Rental Disguise when you go into Sellbot Towers.',
 30156: 'Do you like my Rental Disguise? Sorry about the safety pins!',
 ...
 30161: 'I am looking for a Toon with a Rental Disguise to fight the VP.',
 30162: 'I have a Rental Disguise, and am looking to fight the VP.',
 30163: 'Just walk through the doors to get your Rental Disguise.',
...
SCMenuCustomCogIndices = {'bottom_feeder': (20005, 20014),
 'number_cruncher': (20015, 20024),
 'yesman': (20025, 20035),
 'mover_and_shaker': (20036, 20046),
 'bean_counter': (20047, 20057),
 'cold_caller': (20058, 20070),
 'name_dropper': (20071, 20080),
 'ambulance_chaser': (20081, 20092),
 'two_face': (20093, 20103),
 'head_hunter': (20104, 20114),
 'legal_eagle': (20115, 20124),
 'back_stabber': (20125, 20135),
 'corporate_raider': (20136, 20145),
 'the_big_cheese': (20146, 20156),
 'downsizer': (20157, 20164),
 'glad_hander': (20165, 20177),
 'penny_pincher': (20178, 20187),
 'bloodsucker': (20188, 20199),
 'flunky': (20200, 20210),
 'micromanager': (20211, 20224),
 'tightwad': (20225, 20235),
 'money_bags': (20236, 20245),
 'the_mingler': (20246, 20254),
 'mr_hollywood': (20255, 20266),
 'double_talker': (20267, 20276),
 'pencil_pusher': (20277, 20287),
 'telemarketer': (20288, 20298),
 'big_wig': (20299, 20308),
 'loan_shark': (20309, 20319),
 'robber_baron': (20320, 20329),
 'short_change': (20330, 20331),
 'spin_doctor': (20341, 20350)}
